    ...
    <body class="bg-gray-50 font-sans">
        ...
        <main class="pl-64 min-h-screen">
            ...
            <div class="p-8 mt-16 max-w-3xl">
                ...
                <!-- ✅ ONLY SHOW FORM IF VEHICLE EXISTS -->
                <c:if test="${not empty vehicle}">

                    <div class="mb-6">
                        <a href="${pageContext.request.contextPath}/VehicleController?action=list"
                           class="text-blue-600 flex items-center gap-1 text-sm font-semibold">
                    ...
                    <form action="${pageContext.request.contextPath}/VehicleController"
                        ...
                        <div class="flex justify-end gap-3 mt-8 pt-6 border-t border-gray-50">
                            ...
                            <button type="submit"
                                    class="bg-blue-600 text-white px-8 py-2 rounded-lg font-bold shadow-lg shadow-blue-100 hover:bg-blue-700 transition-all">
                                Save Changes
                            </button>
